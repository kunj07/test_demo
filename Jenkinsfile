	...
	stages {
		...
		stage ('Deploy Stage') {
			steps {
				...
				sh "sudo scp -i  '$WORKSPACE/Q20908-new.pem' -o StrictHostKeyChecking=no -r test_employee.py ec2-user@54.162.194.92:/home/ec2-user"do
				sh 'ssh -i "Q20908-new.pem" ec2-user@ec2-54-162-194-92.compute-1.amazonaws.com'
			}
		}
	}
}
